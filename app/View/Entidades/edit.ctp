...
<?php echo $this->Form->create('Entidade'); ?>
	<fieldset>
		<legend><?php echo __('Edit Entidade'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Entidade.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Entidade.id')))); ?></li>
